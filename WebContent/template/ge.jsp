			...
			<div id="tb" style="float: right;"> 
			 <form action=""> 
                   <input id="ss" class="easyui-searchbox"  
                        prompt="请输入字段注释名"  searcher="doSearch"
				...
				<thead>
					<tr>
					     <th field="ck" checkbox="true"></th>
					      						 <th data-options="field:'pwd'" width="100">pwd </th>
						  						 <th data-options="field:'level'" width="100">level </th>
						  						 <th data-options="field:'age'" width="100">age </th>
						  						 <th data-options="field:'name'" width="100">字段注释 </th>
						  						 <th data-options="field:'creatTime'" width="100">creatTime </th>
						  					</tr>
				</thead>
			</table>
		</div>
			    ...
			    <form method="post"  id="addUser" action="${pageContext.request.contextPath}/save.do">
			    	<table class="dv-table" >
			    			    ...
			    			    <td><input name="name" class="easyui-validatebox" required="true"></input></td>
						  			    		  ...
						  			    		  <tr>
			    		  		<td>creatTime</td>
			    			    <td><input name="creatTime" class="easyui-validatebox" required="true"></input></td>
			    		  </tr>
						  			    	</table>
			    </form>
			</div>
			...
			<div id="win" class="easyui-dialog" title="编辑" data-options="closed:true,iconCls:'icon-save'" buttons="#dlg-buttons" style="width:500px;height:250px;padding:10px 30px;">
				    <form method="post"  id="form" action="${pageContext.request.contextPath}/edit.do">
				    	...
				    	<table class="dv-table" >
				    		  				    		  ...
				    		  				    		  <tr>
				    		  		<td>pwd</td>
				    			    <td><input name="pwd" id="pwd" required="true"></input></td>
				    		  </tr>
							  				    		  <tr>
				    		  		<td>level</td>
				    			    <td><input name="level" id="level" required="true"></input></td>
				    		  </tr>
							  				    		  <tr>
				    		  		<td>age</td>
				    			    <td><input name="age" id="age" required="true"></input></td>
				    		  </tr>
							  				    		  <tr>
				    		  		<td>字段注释</td>
				    			    <td><input name="name" id="name" required="true"></input></td>
							  				    		  ...
							  				    		  <tr>
				    		  		<td>creatTime</td>
				    			    <td><input name="creatTime" id="creatTime" required="true"></input></td>
				    		  </tr>
							  				    	</table>
				    </form>
				</div>
...
<script type="text/javascript">
	  ...
	  function doSearch(value,name){ //用户输入用户名,点击搜素,触发此函数  
	        $("#dg").datagrid({  
	            ...
	            collapsible:true,  
	            toolbar:"#toolbar",  
	            url:'${pageContext.request.contextPath}/vagueSelect.do?keyword='+value, //触发此action,带上参数searcValue  
	            loadMsg:'数据加载中......',  
